...
import { usePortfolioTheme } from "../PortfolioThemeWrapper";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-zinc-900/60 bg-zinc-950/60 backdrop-blur-md">
      <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-lg text-zinc-400 hover:text-white transition duration-150 cursor-pointer flex items-center justify-center hover:bg-zinc-900/30"
